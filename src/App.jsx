...
const PAGES = { dashboard: Dashboard, prayer: Prayer, planning: Planning, checkin: CheckIn, students: Students, attendance: Attendance, followup: FollowUp, events: Events, leaders: Leaders, reports: Reports, finances: Finances, resources: Resources, parentconnect: ParentConnect, messaging: Messaging, ylstory: YLStory, settings: Settings }
