...
const CAMPS = [
  {
    ...
    phone:'(719) 395-6343', website:'https://frontierranch.younglife.org/',
  ...
  },
  {
    ...
    phone:'(828) 686-2451', website:'https://windygap.younglife.org/',
  ...
  },
  {
    ...
    phone:'(530) 675-2209', website:'https://woodleaf.younglife.org/',
  ...
  },
  {
    ...
    phone:'(541) 489-3344', website:'https://washingtonranch.younglife.org/',
  ...
  },
  {
    ...
    phone:'(970) 887-3342', website:'https://crookedcreek.younglife.org/',
  ...
  },
  {
    ...
    phone:'(706) 268-1010', website:'https://sharptopcove.younglife.org/',
...
const GRANTS = [
  ...
  { id:'g85', category:'Faith-Based', name:'United Methodist Church — Advance Special Grants', funder:'United Methodist Church General Board of Global Ministries', amount:'$1,000 – $25,000', cycle:'Annual', eligibility:'Nonprofits with a partnership or endorsement from a UMC congregation.', focus:'Youth ministry, community outreach, evangelism.', tips:'Johnson County has multiple UMC congregations. Ask a local UMC pastor to sponsor Young Life as an Advance Special project. Once approved, any UMC member worldwide can designate gifts to you.', website:'https://umcmission.org/advance/', deadline:'Applications accepted year-round through local conference.', difficulty:'Medium' },
  { id:'g86', category:'Faith-Based', name:'United Methodist Church — Jurisdictional & Conference Grants', funder:'South Central Jurisdiction / Central Texas Conference UMC', amount:'$2,000 – $30,000', cycle:'Annual', eligibility:'Ministries aligned with UMC mission in the South Central Jurisdiction.', focus:'Youth discipleship, evangelism, community service.', tips:'The Central Texas Annual Conference covers Johnson County. Contact the conference office in Fort Worth directly. Youth ministry grants are a priority in this conference.', website:'https://www.ctcumc.org', deadline:'Varies by conference; typically spring.', difficulty:'Medium' },
  { id:'g87', category:'Faith-Based', name:'Catholic Campaign for Human Development', funder:'United States Conference of Catholic Bishops', amount:'$25,000 – $75,000', cycle:'Annual', eligibility:'Nonprofit organizations working to address poverty among low-income communities.', focus:'Economic development, youth empowerment, community organizing.', tips:'Frame Young Life\'s work in underserved Johnson County communities. Partner with a local Catholic parish (St. Joseph\'s in Cleburne) to strengthen the application.', website:'https://www.usccb.org/cchd', deadline:'Applications typically open in the fall.', difficulty:'Hard' },
  { id:'g88', category:'Faith-Based', name:'Catholic Foundation of North Texas', funder:'Catholic Diocese of Fort Worth', amount:'$5,000 – $50,000', cycle:'Annual', eligibility:'Nonprofits serving the Catholic Diocese of Fort Worth, which includes Johnson County.', focus:'Youth ministry, education, social services, community betterment.', tips:'Johnson County falls within the Fort Worth Diocese. Frame ecumenical partnership with local Catholic parishes. Strong fit for youth-serving programs.', website:'https://www.catholicfoundation.com', deadline:'Applications reviewed annually; spring cycle.', difficulty:'Medium' },
  { id:'g89', category:'Faith-Based', name:'Lutheran Community Foundation', funder:'Lutheran Community Foundation', amount:'$1,000 – $20,000', cycle:'Annual', eligibility:'Faith-motivated nonprofits serving communities in need.', focus:'Youth development, community service, education.', tips:'Lutheran foundations have broad ecumenical giving. Connect with Trinity Lutheran Church in Cleburne as a local partner. Frame Young Life\'s relational ministry model.', website:'https://www.lutheranCF.org', deadline:'Rolling applications; reviewed quarterly.', difficulty:'Easy' },
  { id:'g90', category:'Faith-Based', name:'ELCA (Evangelical Lutheran Church) — Fund for Leaders', funder:'Evangelical Lutheran Church in America', amount:'$5,000 – $25,000', cycle:'Annual', eligibility:'Organizations developing Christian leaders, especially among youth.', focus:'Christian leadership development, youth ministry, theological education.', tips:'Young Life\'s leader training pipeline is a strong fit. ELCA has local presence in DFW. Ecumenical partnerships welcome.', website:'https://www.elca.org/grants', deadline:'Applications reviewed annually.', difficulty:'Medium' },
  { id:'g91', category:'Faith-Based', name:'Presbyterian Foundation — New Worshiping Communities', funder:'Presbyterian Church (USA)', amount:'$10,000 – $50,000', cycle:'Annual', eligibility:'Presbyterian-affiliated or broadly evangelical ministries reaching unchurched populations.', focus:'Evangelism, new faith communities, youth outreach.', tips:'Young Life\'s club model reaches unchurched students — frame as new worshiping community development. Partner with First Presbyterian Church Cleburne or Burleson.', website:'https://www.presbyterianfoundation.org', deadline:'Applications reviewed semi-annually.', difficulty:'Medium' },
  { id:'g92', category:'Faith-Based', name:'Baptist General Convention of Texas — Ministry Grants', funder:'Baptist General Convention of Texas', amount:'$2,000 – $20,000', cycle:'Annual', eligibility:'Baptist-affiliated or partnering ministries serving Texas communities.', focus:'Evangelism, youth ministry, church planting, community outreach.', tips:'Johnson County has a very strong BGCT presence. First Baptist churches in Cleburne and Burleson can sponsor Young Life as a partnering ministry. Strong relationship-based process.', website:'https://www.bgct.org', deadline:'Through local Baptist association; typically fall cycle.', difficulty:'Easy' },
  { id:'g93', category:'Faith-Based', name:'Assemblies of God — Benevolence and Ministry Grants', funder:'Assemblies of God USA', amount:'$1,000 – $15,000', cycle:'Annual', eligibility:'Christian ministries focused on youth evangelism and community service.', focus:'Youth evangelism, discipleship, community outreach.', tips:'Several AG churches in Johnson County. Local AG pastors can champion grant applications. Young Life\'s evangelism model aligns strongly with AG priorities.', website:'https://ag.org', deadline:'Contact district office for application cycle.', difficulty:'Easy' },
  { id:'g94', category:'Faith-Based', name:'Church of Christ — Congregational Mission Grants', funder:'Various Church of Christ congregations', amount:'$1,000 – $25,000', cycle:'Relationship-driven', eligibility:'Para-church ministries with alignment to Church of Christ values.', focus:'Youth evangelism, campus ministry, discipleship.', tips:'Church of Christ congregations in Cleburne and Burleson have strong giving cultures. Youth ministry and campus outreach resonate deeply. Build personal relationships with elders and ministers.', website:'N/A — relationship-based', deadline:'No formal cycle; congregation-driven.', difficulty:'Easy' },
  { id:'g95', category:'Faith-Based', name:'Wesleyan Church — Global Partners Grants', funder:'The Wesleyan Church', amount:'$2,000 – $15,000', cycle:'Annual', eligibility:'Evangelical youth ministries with discipleship focus.', focus:'Youth discipleship, evangelism, leadership development.', tips:'Wesleyan churches in Texas have strong youth programming cultures. Frame Young Life as a feeder ministry for local Wesleyan congregations.', website:'https://www.wesleyan.org', deadline:'Annual; contact district superintendent.', difficulty:'Medium' },
  { id:'g96', category:'Faith-Based', name:'Church of the Nazarene — District Ministry Fund', funder:'Southwest Indiana District / South Texas District Church of the Nazarene', amount:'$1,000 – $10,000', cycle:'Annual', eligibility:'Holiness-tradition ministries focused on youth and community.', focus:'Youth evangelism, discipleship, community outreach.', tips:'Nazarene churches have a long history supporting Young Life. Contact the South Texas District office. Local Nazarene pastors can provide letters of endorsement.', website:'https://www.nazarene.org', deadline:'Contact district office; varies.', difficulty:'Easy' },
  { id:'g97', category:'Faith-Based', name:'Episcopal Church — United Thank Offering Grants', funder:'Episcopal Church — United Thank Offering', amount:'$5,000 – $50,000', cycle:'Annual', eligibility:'Ministries working with underserved and marginalized communities.', focus:'Youth development, community outreach, poverty relief.', tips:'UTO grants are competitive but well-funded. Partner with St. Peter\'s Episcopal in Saginaw or a Johnson County Episcopal congregation. Frame Young Life\'s work with rural at-risk youth.', website:'https://www.episcopalchurch.org/uto', deadline:'Applications open in January; due in April.', difficulty:'Hard' },
  { id:'g98', category:'Faith-Based', name:'Alliance of Baptists — Ministry Grants', funder:'Alliance of Baptists', amount:'$2,000 – $15,000', cycle:'Annual', eligibility:'Progressive and moderate Baptist-aligned nonprofits serving youth and community.', focus:'Youth ministry, community justice, education.', tips:'Moderate Baptist congregations in Johnson County area. Frame Young Life\'s inclusive community approach.', website:'https://allianceofbaptists.org', deadline:'Applications reviewed annually.', difficulty:'Medium' },
  { id:'g99', category:'Faith-Based', name:'Christian Reformed Church — Diaconal Ministries Grants', funder:'Christian Reformed Church in North America', amount:'$5,000 – $30,000', cycle:'Annual', eligibility:'Reformed evangelical nonprofits with strong community service components.', focus:'Youth ministry, community development, poverty relief.', tips:'CRC has a strong grant culture for para-church youth ministries. Frame Young Life\'s ministry through a Reformed theology lens — covenant community and youth flourishing.', website:'https://www.crcna.org', deadline:'Applications reviewed semi-annually.', difficulty:'Medium' },

  // ── UNIVERSITIES & ACADEMIC FOUNDATIONS ──────────────────────────────────
  { id:'g100', category:'Youth & Community', name:'Texas Christian University — Community Engagement Grants', funder:'TCU Office of Community Engagement', amount:'$1,000 – $10,000', cycle:'Annual', eligibility:'Fort Worth-area nonprofits partnering with TCU students or faculty.', focus:'Youth development, education, community service.', tips:'TCU is 40 miles from Johnson County. Propose a service-learning partnership where TCU students volunteer as Young Life leaders or interns. Academic partnership strengthens both the grant and your talent pipeline.', website:'https://www.tcu.edu/community', deadline:'Applications reviewed annually in spring.', difficulty:'Easy' },
  { id:'g101', category:'Youth & Community', name:'University of Texas at Arlington — Community Impact Grants', funder:'UTA Division of Student Affairs / Community Engagement', amount:'$500 – $5,000', cycle:'Annual', eligibility:'DFW nonprofits engaging UTA students in community service.', focus:'Youth development, education, community betterment.', tips:'UTA is 45 miles from Cleburne. Frame a student volunteer or internship partnership. UTA students in social work, education, or kinesiology are strong Young Life leader candidates.', website:'https://www.uta.edu/community', deadline:'Rolling; contact community engagement office.', difficulty:'Easy' },
  { id:'g102', category:'Youth & Community', name:'Baylor University — George W. Truett Theological Seminary Grants', funder:'Baylor University / Truett Seminary', amount:'$2,000 – $15,000', cycle:'Annual', eligibility:'Christian nonprofits partnering with Baylor students in ministry formation.', focus:'Youth ministry, theological education, Christian community development.', tips:'Baylor is 70 miles from Cleburne. Truett Seminary trains ministry leaders — Young Life is a natural field placement partner. Propose a ministry internship program. Seminary students gain credit; Young Life gains trained leaders.', website:'https://www.baylor.edu/truett', deadline:'Contact field education office; varies.', difficulty:'Medium' },
  { id:'g103', category:'Youth & Community', name:'Tarleton State University — Community Partnership Grants', funder:'Tarleton State University (Stephenville)', amount:'$1,000 – $8,000', cycle:'Annual', eligibility:'Nonprofits within Tarleton\'s service region including Johnson County.', focus:'Rural community development, youth education, workforce.', tips:'Tarleton is just 45 miles from Cleburne and serves the same rural Texas region. Strong fit for rural youth programming. Education and social work departments are natural partners.', website:'https://www.tarleton.edu', deadline:'Contact community engagement office.', difficulty:'Easy' },
  { id:'g104', category:'Youth & Community', name:'Texas Wesleyan University — Faith & Service Grants', funder:'Texas Wesleyan University (Fort Worth)', amount:'$1,000 – $7,500', cycle:'Annual', eligibility:'Faith-motivated nonprofits in Fort Worth / Johnson County area.', focus:'Youth ministry, community service, faith-based education.', tips:'Texas Wesleyan is 30 miles from Burleson. Methodist-rooted institution with strong community service culture. Propose student volunteer placements with Young Life clubs.', website:'https://www.txwes.edu', deadline:'Annual; contact service learning office.', difficulty:'Easy' },
  { id:'g105', category:'Youth & Community', name:'Southwestern Baptist Theological Seminary — Ministry Partnership', funder:'SWBTS Fort Worth', amount:'$2,000 – $12,000', cycle:'Annual', eligibility:'Baptist-aligned or evangelical para-church ministries in the DFW region.', focus:'Youth evangelism, discipleship, ministry training.', tips:'SWBTS is one of the largest Baptist seminaries in the world, located in Fort Worth. Seminary students need field ministry placements — Young Life is an ideal partner. Ministry internship grants fund student stipends.', website:'https://www.swbts.edu', deadline:'Contact field education office.', difficulty:'Medium' },
  { id:'g106', category:'Youth & Community', name:'Dallas Theological Seminary — Ministry Grants', funder:'Dallas Theological Seminary', amount:'$2,000 – $15,000', cycle:'Annual', eligibility:'Evangelical nonprofits providing ministry training opportunities.', focus:'Biblical youth ministry, discipleship, theological education.', tips:'DTS is 40 miles from Cleburne. DTS students frequently serve with Young Life. Formalize the partnership with a grant-funded internship program. DTS alumni are major donors in the DFW evangelical community.', website:'https://www.dts.edu', deadline:'Contact ministry partnerships office.', difficulty:'Medium' },
  { id:'g107', category:'Youth & Community', name:'Abilene Christian University — Community Grants', funder:'ACU College of Biblical Studies / Community Engagement', amount:'$1,000 – $8,000', cycle:'Annual', eligibility:'Churches of Christ-aligned or broadly evangelical nonprofits.', focus:'Youth ministry, community service, biblical education.', tips:'ACU has strong ties to the Churches of Christ community throughout Texas. Frame Young Life\'s outreach as campus evangelism aligned with ACU\'s mission.', website:'https://www.acu.edu', deadline:'Annual; contact community engagement.', difficulty:'Medium' },

  // ── ADDITIONAL CORPORATE ──────────────────────────────────────────────────
  { id:'g108', category:'Corporate', name:'Raytheon Technologies Foundation', funder:'Raytheon Technologies (RTX)', amount:'$5,000 – $50,000', cycle:'Annual', eligibility:'STEM and education nonprofits near RTX facilities (DFW region).', focus:'STEM education, workforce development, veterans, youth.', tips:'RTX has major DFW operations. Frame mentorship as workforce pipeline. STEM angle works best; note that keeping students in school leads to career readiness.', website:'https://www.rtx.com/raytheon/community', deadline:'Applications reviewed annually.', difficulty:'Medium' },
  { id:'g109', category:'Corporate', name:'Sabre Corporation Foundation', funder:'Sabre Corporation (Southlake, TX)', amount:'$5,000 – $25,000', cycle:'Annual', eligibility:'DFW nonprofits in education and community development.', focus:'Education, STEM, community betterment.', tips:'Sabre is headquartered in Southlake, very close to Johnson County. Local DFW nonprofit with education focus is a strong match. Contact community affairs team.', website:'https://www.sabre.com/about/corporate-responsibility', deadline:'Applications reviewed annually.', difficulty:'Medium' },
  { id:'g110', category:'Corporate', name:'BNSF Railway Foundation', funder:'BNSF Railway', amount:'$2,500 – $25,000', cycle:'Annual', eligibility:'Nonprofits in BNSF operating communities.', focus:'Education, youth, safety, community development.', tips:'BNSF operates through Johnson County. Very Texas-friendly funder. Youth education and community betterment are priority categories. Contact BNSF community affairs in Fort Worth.', website:'https://www.bnsf.com/communities', deadline:'Applications accepted year-round.', difficulty:'Easy' },
  { id:'g111', category:'Corporate', name:'Burlington Northern Santa Fe (BNSF) — Giving Tuesday Match', funder:'BNSF Railway Foundation', amount:'$1,000 – $10,000', cycle:'Annual (December)', eligibility:'Nonprofits in BNSF communities with active Giving Tuesday campaigns.', focus:'General community betterment.', tips:'BNSF matches employee donations on Giving Tuesday. Recruit any BNSF employees among Young Life families or donors to participate. Easy match opportunity with no separate application.', website:'https://www.bnsf.com/communities', deadline:'Giving Tuesday (late November).', difficulty:'Easy' },
  { id:'g112', category:'Corporate', name:'Starbucks Foundation — Community Grant', funder:'Starbucks Foundation', amount:'$2,500 – $15,000', cycle:'Annual', eligibility:'Nonprofits near Starbucks stores; youth and community focus.', focus:'Youth opportunity, community resilience, education.', tips:'Starbucks stores in Burleson and Cleburne area. Youth opportunity framing is a strong fit. Starbucks partners (employees) can champion grants for their communities.', website:'https://www.starbucks.com/responsibility/community', deadline:'Applications reviewed annually.', difficulty:'Medium' },
  { id:'g113', category:'Corporate', name:'CenterPoint Energy Foundation', funder:'CenterPoint Energy', amount:'$1,000 – $15,000', cycle:'Annual', eligibility:'Nonprofits in CenterPoint service territories (Texas included).', focus:'Education, community safety, disaster relief, youth.', tips:'CenterPoint serves parts of Texas. Youth education and community betterment are primary categories. Contact community affairs team.', website:'https://www.centerpointenergy.com/community', deadline:'Rolling with annual review.', difficulty:'Easy' },
  { id:'g114', category:'Corporate', name:'D.R. Horton — Community Investment', funder:'D.R. Horton Inc.', amount:'$2,000 – $20,000', cycle:'Annual', eligibility:'Nonprofits in D.R. Horton homebuilding communities (Johnson County included).', focus:'Youth development, education, community.', tips:'D.R. Horton is headquartered in Fort Worth and actively builds in Burleson and Cleburne. Strong local connection. Youth and family community focus resonates with homebuilder brand values.', website:'https://www.drhorton.com', deadline:'Contact local division community affairs.', difficulty:'Easy' },
  { id:'g115', category:'Corporate', name:'Builders FirstSource Foundation', funder:'Builders FirstSource Inc.', amount:'$2,000 – $15,000', cycle:'Annual', eligibility:'Nonprofits in communities where BFS operates (major Texas presence).', focus:'Community development, youth, workforce.', tips:'Builders FirstSource is headquartered in Dallas with major Texas operations. Community giving program focuses on where employees live and work. Young Life leaders who work in construction industry are ideal connection points.', website:'https://www.buildersfirstsource.com', deadline:'Annual; contact corporate affairs.', difficulty:'Easy' },
  { id:'g116', category:'Corporate', name:'Pier 1 Charitable Foundation (Heritage)', funder:'Local successor charitable funds from Pier 1 liquidation', amount:'$500 – $5,000', cycle:'Relationship-driven', eligibility:'Local Fort Worth-area nonprofits.', focus:'Youth, arts, community.', tips:'Post-liquidation charitable assets were distributed to DFW community foundations. Check Communities Foundation of Texas and Fort Worth Community Foundation for successor funds.', website:'https://www.cftexas.org', deadline:'Through host community foundation.', difficulty:'Easy' },
  { id:'g117', category:'Corporate', name:'Ryan LLC Foundation (Dallas)', funder:'Ryan LLC', amount:'$5,000 – $25,000', cycle:'Annual', eligibility:'DFW nonprofits focused on youth and education.', focus:'Youth development, education, community betterment.', tips:'Ryan LLC is a major Dallas-based tax firm with active community giving. DFW youth focus is a priority. Ryan employees who are Young Life donors are strong introduction points.', website:'https://www.ryan.com/about/social-responsibility', deadline:'Annual; contact corporate foundation.', difficulty:'Medium' },
  { id:'g118', category:'Corporate', name:'Pioneer Natural Resources Foundation', funder:'Pioneer Natural Resources (Irving, TX)', amount:'$5,000 – $50,000', cycle:'Annual', eligibility:'Texas nonprofits in Pioneer operating communities.', focus:'Education, youth, community development, environmental stewardship.', tips:'Pioneer operates in West and North Texas. DFW headquarters gives access to community grants. Youth education and community betterment are strong fits.', website:'https://www.pxd.com/sustainability/community', deadline:'Applications reviewed annually.', difficulty:'Medium' },
  { id:'g119', category:'Corporate', name:'Hall Financial Group — Charitable Giving', funder:'Craig Hall / Hall Group (Dallas)', amount:'$5,000 – $50,000', cycle:'Relationship-driven', eligibility:'DFW evangelical Christian nonprofits with strong leadership.', focus:'Faith-based community development, youth, education.', tips:'Craig Hall is a known Christian philanthropist in Dallas. Relationship-driven giving — connect through Young Life\'s Dallas-area board network or DFW evangelical business community.', website:'N/A — relationship-based', deadline:'No formal cycle.', difficulty:'Medium' },
  { id:'g120', category:'Corporate', name:'Texas Capital Bancshares Foundation', funder:'Texas Capital Bank', amount:'$2,500 – $20,000', cycle:'Annual', eligibility:'Texas nonprofits in Texas Capital Bank markets.', focus:'Education, community development, financial empowerment.', tips:'Texas Capital has Fort Worth presence. Community grant process is straightforward. Youth education angle works well.', website:'https://www.texascapitalbank.com/community', deadline:'Applications reviewed annually.', difficulty:'Medium' },

  // ── ADDITIONAL GOVERNMENT ─────────────────────────────────────────────────
  { id:'g121', category:'Government', name:'Johnson County — Commissioners Court Community Grants', funder:'Johnson County Commissioners Court', amount:'$500 – $10,000', cycle:'Annual', eligibility:'Johnson County nonprofits providing essential community services.', focus:'Community services, youth, health, safety.', tips:'Annual county budget cycle includes discretionary community grants. Attend Commissioners Court meetings. Each commissioner represents a precinct — identify which precinct your strongest donors live in and build that relationship first.', website:'https://www.johnsoncountytx.org', deadline:'Budget cycle — apply summer/fall for next fiscal year.', difficulty:'Easy' },
  { id:'g122', category:'Government', name:'City of Cleburne — Community Development Grants', funder:'City of Cleburne', amount:'$500 – $5,000', cycle:'Annual', eligibility:'Cleburne nonprofits providing direct community services.', focus:'Youth, community betterment, public safety.', tips:'Cleburne City Council has discretionary community grant funds. Attend city council meetings, present Young Life\'s impact data, and apply during the annual budget process. A council member champion makes a significant difference.', website:'https://www.cleburne.net', deadline:'Annual budget process; typically summer.', difficulty:'Easy' },
  { id:'g123', category:'Government', name:'City of Burleson — Community Grants', funder:'City of Burleson', amount:'$500 – $5,000', cycle:'Annual', eligibility:'Burleson nonprofits serving Burleson residents.', focus:'Youth, community services, education.', tips:'Burleson\'s rapid growth has increased city revenue. Community grants are available through the city\'s budget process. Young Life\'s strong Burleson program is a natural fit.', website:'https://www.burlesontx.com', deadline:'Annual budget cycle; contact city manager\'s office.', difficulty:'Easy' },
  { id:'g124', category:'Government', name:'Texas Governor\'s Criminal Justice Division — Victim Services', funder:'Texas Governor\'s Office / TCJS', amount:'$25,000 – $200,000', cycle:'Annual', eligibility:'Texas nonprofits providing services to at-risk and crime-affected youth.', focus:'At-risk youth, crime prevention, victim services, mentoring.', tips:'Young Life reaches students who are at elevated risk for involvement in crime — frame mentorship as crime prevention. Partner with Johnson County DA\'s office or juvenile probation department to strengthen the application.', website:'https://gov.texas.gov/organization/cjd', deadline:'Annual RFP; varies by grant program.', difficulty:'Hard' },
  { id:'g125', category:'Government', name:'Texas Commission on the Arts — Community Arts Grants', funder:'Texas Commission on the Arts', amount:'$2,000 – $25,000', cycle:'Annual', eligibility:'Texas nonprofits incorporating arts in community programming.', focus:'Arts education, community arts, youth creative programming.', tips:'If Young Life incorporates music, drama, film, or creative arts in its programming, this is a fit. Even club-night skits and worship music can qualify as community arts programming.', website:'https://www.arts.texas.gov', deadline:'Applications reviewed semi-annually.', difficulty:'Medium' },
  { id:'g126', category:'Government', name:'FEMA — Nonprofit Security Grant Program', funder:'Federal Emergency Management Agency / DHS', amount:'$10,000 – $150,000', cycle:'Annual', eligibility:'501(c)(3) faith-based and community nonprofits at risk of attack.', focus:'Security equipment, training, planning for at-risk nonprofits.', tips:'Faith-based organizations are a priority category. Use this to fund security cameras, lighting, locks, and staff safety training at Young Life club venues and office spaces. Apply through the Texas Division of Emergency Management.', website:'https://www.fema.gov/grants/preparedness/nonprofit-security', deadline:'Annual; TDEM announcement usually in spring.', difficulty:'Medium' },
  { id:'g127', category:'Government', name:'Texas Parks & Wildlife — Outdoor Recreation Grants', funder:'Texas Parks & Wildlife Department', amount:'$5,000 – $50,000', cycle:'Annual', eligibility:'Nonprofits providing outdoor recreation programs for youth.', focus:'Outdoor recreation, environmental education, youth nature access.', tips:'Young Life\'s camp-based ministry is deeply connected to outdoor adventure. Frame club camping trips, nature hikes, and outdoor activities as outdoor recreation programming. Strong fit for rural Johnson County.', website:'https://tpwd.texas.gov/business/grants', deadline:'Annual; contact TPWD grants division.', difficulty:'Medium' },
  { id:'g128', category:'Government', name:'U.S. Forest Service — Youth Conservation Corps Grants', funder:'U.S. Forest Service / Dept. of Agriculture', amount:'$15,000 – $100,000', cycle:'Annual', eligibility:'Nonprofits operating youth conservation and outdoor corps programs.', focus:'Youth employment, conservation, outdoor education.', tips:'If Young Life can incorporate a conservation service component into camp or outdoor programming, this grant funds youth stipends for conservation work. Good for combining summer camp with community service hours.', website:'https://www.fs.usda.gov/working-with-us/grants', deadline:'Annual RFP; contact USDA regional office.', difficulty:'Hard' },
...
const CHURCHES = [
  // ── CLEBURNE ─────────────────────────────────────────────────────────────
  { id:'ch1', name:'First Baptist Church Cleburne', denomination:'Southern Baptist', city:'Cleburne', address:'202 N Anglin St, Cleburne, TX 76033', phone:'(817) 641-2564', website:'https://www.firstbaptistcleburne.org', youthPastor:'Contact church', youthPhone:'(817) 641-2564', youthEmail:'', notes:'One of the largest SBC churches in JC. Strong missions culture. Historical YL partner. Potential venue for banquets and leader training.' },
  { id:'ch2', name:'Cornerstone Baptist Church', denomination:'Southern Baptist', city:'Cleburne', address:'2900 W Henderson St, Cleburne, TX 76033', phone:'(817) 641-8000', website:'https://cornerstonepcg.com', youthPastor:'Contact church', youthPhone:'(817) 641-8000', youthEmail:'', notes:'Active community ministry congregation. Good venue partner and donor cultivation base.' },
  ...
  { id:'ch4', name:'First United Methodist Church Cleburne', denomination:'United Methodist', city:'Cleburne', address:'303 N Anglin St, Cleburne, TX 76033', phone:'(817) 645-3033', website:'https://www.fumccleburne.com', youthPastor:'Contact church', youthPhone:'(817) 645-3033', youthEmail:'', notes:'Historic downtown church. Large congregation with established youth program. Good donor cultivation base.' },
  { id:'ch5', name:'First Christian Church Cleburne', denomination:'Christian Church', city:'Cleburne', address:'400 W Chambers St, Cleburne, TX 76033', phone:'(817) 645-8044', website:'https://firstcleburne.org', youthPastor:'Contact church', youthPhone:'(817) 645-8044', youthEmail:'', notes:'Disciples of Christ tradition. Mid-size congregation. Community-focused ministry.' },
  ...
  { id:'ch9', name:'United Presbyterian Church Cleburne', denomination:'Presbyterian (USA)', city:'Cleburne', address:'400 N Robinson St, Cleburne, TX 76033', phone:'(817) 645-2554', website:'https://www.upccleburne.org', youthPastor:'Contact church', youthPhone:'(817) 645-2554', youthEmail:'', notes:'Traditional Presbyterian congregation. Good venue for smaller events. Presbyterian grant connections.' },
  { id:'ch10', name:'Calvary Baptist Church Cleburne', denomination:'Southern Baptist', city:'Cleburne', address:'1501 Nolan River Rd, Cleburne, TX 76033', phone:'(817) 641-4130', website:'https://www.calvarycleburne.com', youthPastor:'Matthew Sisk', youthPhone:'(817) 641-4130', youthEmail:'', notes:'Mid-size SBC congregation serving south Cleburne area. Tight-knit community.' },
  { id:'ch11', name:'Westhill Church of Christ', denomination:'Church of Christ', city:'Cleburne', address:'1600 W Henderson St, Cleburne, TX 76033', phone:'(817) 641-3122', website:'https://westhillchurch.net', youthPastor:'Jesse Muniz', youthPhone:'(817) 641-3122', youthEmail:'', notes:'Church of Christ congregation (formed from merger of Westside and Central CoC). Strong eldership giving culture. Jesse Muniz serves as Youth & Family Minister.' },
  { id:'ch12', name:'Bethel Assembly of God Cleburne', denomination:'Assemblies of God', city:'Cleburne', address:'1200 N Nolan River Rd, Cleburne, TX 76033', phone:'(817) 641-5300', website:'https://bethelcleburne.org', youthPastor:'Contact church', youthPhone:'(817) 641-5300', youthEmail:'', notes:'Pentecostal congregation. Youth evangelism emphasis aligns with YL mission.' },
  { id:'ch13', name:'Faith Community Church Cleburne', denomination:'Non-Denominational', city:'Cleburne', address:'900 N Main St, Cleburne, TX 76031', phone:'(817) 641-7700', website:'', youthPastor:'Contact church', youthPhone:'(817) 641-7700', youthEmail:'', notes:'Contemporary congregation. Family-oriented. Youth program looking for camp partnerships.' },
  { id:'ch14', name:'1Life Church Cleburne', denomination:'Non-Denominational', city:'Cleburne', address:'2400 W Henderson St, Cleburne, TX 76033', phone:'(817) 641-9100', website:'https://www.1lifechurchcleburne.com', youthPastor:'Contact church', youthPhone:'(817) 641-9100', youthEmail:'', notes:'Young, growing congregation. Strong student culture. Natural YL partner church.' },

  // ── BURLESON ──────────────────────────────────────────────────────────────
  { id:'ch16', name:'First Baptist Church Burleson', denomination:'Southern Baptist', city:'Burleson', address:'444 SW Johnson Ave, Burleson, TX 76028', phone:'(817) 295-1511', website:'https://www.fbcburleson.org', youthPastor:'Matt Armendarez', youthPhone:'(817) 295-1511', youthEmail:'info@fbcburleson.org', notes:'One of the largest churches in Burleson. Strong missions culture. Key YL partnership — multiple leaders from this congregation.' },
  ...
  { id:'ch21', name:'Cross Timbers Church Burleson', denomination:'Non-Denominational', city:'Burleson', address:'2010 S Burleson Blvd, Burleson, TX 76028', phone:'(817) 426-8000', website:'https://www.crosstimbers.org', youthPastor:'Contact church', youthPhone:'(817) 426-8000', youthEmail:'', notes:'Contemporary church. Student ministry emphasis. Natural YL feeder and volunteer pipeline.' },
  { id:'ch22', name:'Burleson Church of Christ', denomination:'Church of Christ', city:'Burleson', address:'300 SW Johnson Ave, Burleson, TX 76028', phone:'(817) 295-4200', website:'https://burlesoncoc.com', youthPastor:'Mason Hill', youthPhone:'(817) 295-4200', youthEmail:'', notes:'Established Church of Christ congregation. Youth ministry and para-church partnerships welcome.' },
  { id:'ch23', name:'Life.Church Burleson', denomination:'Non-Denominational', city:'Burleson', address:'1000 NE Alsbury Blvd, Burleson, TX 76028', phone:'(918) 491-7300', website:'https://www.life.church/locations/burleson', youthPastor:'Contact church', youthPhone:'(918) 491-7300', youthEmail:'', notes:'National mega-church campus. Large youth ministry. High-capacity volunteer network. Strong tech and media resources.' },
  { id:'ch24', name:'Burleson Assembly of God', denomination:'Assemblies of God', city:'Burleson', address:'500 SW Wilshire Blvd, Burleson, TX 76028', phone:'(817) 295-8800', website:'https://www.bursaog.com', youthPastor:'Contact church', youthPhone:'(817) 295-8800', youthEmail:'', notes:'Pentecostal congregation. Youth evangelism-focused. Camp partnership potential.' },
  ...
  { id:'ch27', name:'Oak Grove Baptist Church', denomination:'Southern Baptist', city:'Burleson', address:'11805 Oak Grove Rd S, Burleson, TX 76028', phone:'(817) 447-2626', website:'https://www.oakgrove.church', youthPastor:'Dakota Harvey', youthPhone:'(817) 447-2626', youthEmail:'', notes:'Rural SBC church between Burleson and Joshua. Farm community families. Strong outreach culture.' },
  ...
  // ── ALVARADO ──────────────────────────────────────────────────────────────
  { id:'ch35', name:'First Baptist Church Alvarado', denomination:'Southern Baptist', city:'Alvarado', address:'200 W College Ave, Alvarado, TX 76009', phone:'(817) 790-2500', website:'https://www.fbcalvarado.org', youthPastor:'Contact church', youthPhone:'(817) 790-2500', youthEmail:'', notes:'Rural community anchor. Congregation overlaps with Alvarado ISD families. Key YL outreach partner in Alvarado.' },
  ...
  // ── GODLEY ────────────────────────────────────────────────────────────────
  { id:'ch39', name:'First Baptist Church Godley', denomination:'Southern Baptist', city:'Godley', address:'200 S Main St, Godley, TX 76044', phone:'(817) 389-2200', website:'https://fbcgodley.com', youthPastor:'Ethan Smith', youthPhone:'(817) 389-2200', youthEmail:'', notes:'Small-town church. Tight-knit congregation in Godley. Good outreach partner for Godley High students.' },
  ...
  // ── GRANDVIEW ─────────────────────────────────────────────────────────────
  { id:'ch42', name:'First Baptist Church Grandview', denomination:'Southern Baptist', city:'Grandview', address:'200 E College Ave, Grandview, TX 76050', phone:'(817) 866-3200', website:'https://fbcgrandview.org', youthPastor:'Eric Waits', youthPhone:'(817) 866-3200', youthEmail:'', notes:'Community SBC anchor in Grandview. Serves Grandview ISD families. Key outreach point for southern JC.' },
  ...
  { id:'ch46', name:'First Baptist Church Venus', denomination:'Southern Baptist', city:'Venus', address:'200 E Main St, Venus, TX 76084', phone:'(972) 366-3600', website:'https://www.fbcvenus.com', youthPastor:'Contact church', youthPhone:'(972) 366-3600', youthEmail:'', notes:'SBC church in Venus. Rural community ties. Venus High School families.' },

  // ── RIO VISTA ─────────────────────────────────────────────────────────────
  { id:'ch47', name:'First Baptist Church Rio Vista', denomination:'Southern Baptist', city:'Rio Vista', address:'100 N Main St, Rio Vista, TX 76093', phone:'(817) 373-2300', website:'https://www.fbcrv.org', youthPastor:'Stetson Allen', youthPhone:'(817) 373-2300', youthEmail:'', notes:'Small rural SBC church. Serves Rio Vista ISD families. Western JC outreach.' },
  ...
  { id:'ch52', name:'First Baptist Church Crowley', denomination:'Southern Baptist', city:'Crowley', address:'300 Church St, Crowley, TX 76036', phone:'(817) 297-2800', website:'https://www.fbccrowley.org', youthPastor:'Contact church', youthPhone:'(817) 297-2800', youthEmail:'', notes:'SBC church on JC border. Students from both Crowley and Burleson ISDs.' },
  ...
  { id:'ch55', name:'Gateway Church (JC Area)', denomination:'Non-Denominational', city:'Burleson', address:'(Nearest campus: South Fort Worth / Crowley)', phone:'(817) 328-1000', website:'https://www.gatewaypeople.com', youthPastor:'Tony Villafane', youthPhone:'(817) 328-1000', youthEmail:'', notes:'Large evangelical church with South FW campus drawing many JC families. Student ministry emphasis. Major donor community.' },
]
